                    ...
                    <form class="card p-3" action="<?=$url?>" method="POST">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                                <label for="">Nom du departement <span class="text-danger">*</span></label>
                                <input autocomplete="off" required type="text" class="form-control" placeholder="Ex: IGAF" name="nomdep"
                                    <?php if (isset($_GET['idpro'])) { ?> value="<?php echo $tab['nomdep']; ?> <?php }?>">
                            </div>
                            ...
                            <?php
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='departement.php?idpro=<?=$idpro['id'] ?>' class="btn btn-info btn-sm "><i
                                                        class="bi bi-pencil-square"></i></a>
                                                <a onclick=" return confirm('Voulez-vous vraiment supprimer ?')"
                                                    href='../models/delete/del-departement-post.php?idSupcat=<?=$idpro['id'] ?>'
